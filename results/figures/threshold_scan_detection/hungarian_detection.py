...
# Data
data = np.array([
    [0.38993, 0.40420, 0.40705, 0.38937, 0.37036],
])
...
ax.set_xlabel('Confidence Threshold Value')
ax.set_ylabel('HOTA Score')
ax.set_title('HOTA Scores for Detection Thresholds with Hungarian Algorithm')
ax.set_ylim(0, 0.6)

plt.tight_layout()
# plt.show()

plt.savefig('Desktop/KCF_YOLO/results/figures/threshold_scan_detection/hungarian_detection.png', dpi=300, bbox_inches='tight')
