...
data = np.array([
    ...
    [0.35823, 0.45001, 0.44932, 0.43478, 0.41026],  # IoU Doubly Thresholded
    [0.42288, 0.42625, 0.43119, 0.43411, 0.43287],  # IoS Doubly Thresholded
])
...
plt.savefig('Desktop/KCF_YOLO/results/figures/threshold_scan_matching/hungarian_4_matching_types.png', dpi=300, bbox_inches='tight')
